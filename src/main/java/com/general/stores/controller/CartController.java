...
public class CartController {
	...
	@PostMapping("/create_order")  //payment from razorpay
	@ResponseBody
	public String createOrder( @RequestBody Map<String, Object> data) throws RazorpayException {
		System.out.println("order sent");
	    String str= data.get("amount").toString();
	    int amt=(int) Double.valueOf(str).doubleValue();
	    System.out.println(amt);
		RazorpayClient razorpay = null;
		
			razorpay = new RazorpayClient("rzp_test_iHqgygnuQ4zqAP","Dp7V7YcCt5OwXE41qGtsBXVE");
		...
		com.razorpay.Order order = razorpay.Orders.create(ob);
